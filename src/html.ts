...
const viteTagDisclaimer = '{% comment %}\n  IMPORTANT: This snippet is automatically generated by tushy-vite-plugin.\n  Do not attempt to modify this file directly, as any changes will be overwritten by the next build.\n{% endcomment %}\n'
...
%}${reactPlugin === undefined
    ? ''
    : `
<script src="${assetHost}/@id/__x00__tushy-vite-plugin:react-refresh" type="module"></script>`}
