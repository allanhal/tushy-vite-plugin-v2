...
const debug = createDebugger('tushy-vite-plugin-v2:html')
...
export default function shopifyHTML(options: Required<Options>): Plugin {
  ...
  return {
    name: 'tushy-vite-plugin-v2-html',
    enforce: 'post',
...
const viteTagDisclaimer = '{% comment %}\n  IMPORTANT: This snippet is automatically generated by tushy-vite-plugin-v2.\n  Do not attempt to modify this file directly, as any changes will be overwritten by the next build.\n{% endcomment %}\n'
...
const scriptTag = (fileName: string): string =>
  `<script defer src="{{ '${fileName}' | asset_url }}" type="module" crossorigin="anonymous"></script>`
...
%}${reactPlugin === undefined
    ? ''
    : `
<script defer src="${assetHost}/@id/__x00__tushy-vite-plugin-v2:react-refresh" type="module"></script>`}
<script defer src="${assetHost}/@vite/client" type="module"></script>
{% if is_css == true %}
  {{ file_url | stylesheet_tag }}
{% else %}
  <script defer src="{{ file_url }}" type="module"></script>
{% endif %}
`
